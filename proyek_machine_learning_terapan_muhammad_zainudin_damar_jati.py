...
Original file is located at
    https://colab.research.google.com/drive/1vuUyMdA1eUPOLU65iTSTx9MATpbQR_O-
...
Kode berikut digunakan untuk mengetahui fitur mana yang paling berpengaruh terhadap model prediksi harga rumah. Metode yang digunakan adalah Permutation Importance, yaitu dengan mengacak nilai suatu fitur dan mengukur penurunan performa model.
"""

from sklearn.inspection import permutation_importance

X_test_processed = best_model.named_steps["preprocessing"].transform(X_test)
regressor = best_model.named_steps["regressor"]
feature_names = best_model.named_steps["preprocessing"].get_feature_names_out()
result = permutation_importance(regressor, X_test_processed, y_test, n_repeats=10, random_state=42, n_jobs=-1)
